...
export default function App() {
  ...
  const playSong = useCallback(() => {
    ...
    audio.play().catch((err) => {
      // Browsers can block playback if it's not triggered directly by a
      // user gesture; this catch just prevents an unhandled promise error.
  ...
  }, [stage, consoleFinished, playSong]);
